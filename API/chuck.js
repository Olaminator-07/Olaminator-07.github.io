async function hentData() {
    const res = await fetch('https://api.adsbdb.com/v0/aircraft/random');
    ...
    let sistoppdatert = document.createElement("p");
    sistoppdatert.innerText = data.updated_at;
    document.querySelector("#vits").appendChild(sistoppdatert);
}
