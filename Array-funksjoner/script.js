...
// Skriv koden din her:
const merenn3ordklasser = ordbok.filter(ordklasse => ordklasse.ordklasser.length >= 3);
console.log(merenn3ordklasser);
...
// Skriv koden din her:
const forstepopover85 = ordbok.find(populer => populer.popularitet > 85);
console.log(forstepopover85);
...
// Skriv koden din her:
const orda = ordbok.map(ordene => ordene.ord);
console.log(orda);
...
// Skriv koden din her:
const ordogklasse = ordbok.map(data => ({
    ord: data.ord,
    antallordklasser: data.ordklasser.length
}));
console.log(ordogklasse);
...
// Skriv koden din her:
const totalordklasser = ordbok.reduce((sum, klasser) => sum + klasser.ordklasser.length, 0);
...
// Skriv koden din her:
const totalpopularitet = ordbok.reduce((sum, pop) => sum + pop.popularitet, 0);
const gjennomsnittpop = totalpopularitet/ ordbok.length;
console.log(gjennomsnittpop);
...
// Skriv koden din her:
const verbperhaps = ordbok.some(verb => 
    verb.ordklasser.some(ordklasse => ordklasse.type === "verb"));
console.log(verbperhaps);
